    ...
    this.#root.innerHTML = /* html */ `
      <div class="h-full flex justify-center items-center text-gray-400">
        <form class="flex items-center gap-2">
          <input type="text" name="location" id="location" placeholder="Enter a city name..." autofocus required class="outline-none focus:ring-2 focus:ring-indigo-300 border rounded-md shadow p-2 text-center transition">
